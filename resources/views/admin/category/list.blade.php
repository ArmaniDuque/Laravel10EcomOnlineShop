                ...
                <div class=" card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{ route('categories.index') }}'"
                            class="btn btn-info btn-sm">Reset</button>
                    </div>
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $category->id }}</td>
                            <td><img src="{{ asset('uploads/category/'.$category->image)}}" alt="" style="width:100px;">
                            </td>
                            <td>{{ $category->name }}</td>
                            <td>{{ $category->slug }}</td>
                            <td>
...
function deleteCategory(id) {
    ...
    // return false;
    if (confirm("Are you sere you want to delete")) {
